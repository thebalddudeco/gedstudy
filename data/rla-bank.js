...
(function addRlaBank() {
  ...
  var grammarSpecs = [
    ...
    ["Choose the best revision.", ["Michael brought his transcript to the advisor because he wanted clearer guidance.", "Michael brought his transcript, because he wanted clearer guidance.", "Michael brought his transcript because, he wanted clearer guidance to the advisor.", "Because Michael brought his transcript to the advisor clearer guidance."], "Michael brought his transcript to the advisor because he wanted clearer guidance.", "The correct sentence keeps the cause-and-effect relationship clear without unnecessary punctuation."],
    ...
    ["Which sentence uses capitalization correctly?", ["Michael plans to visit helena Community College in July.", "Michael plans to visit Helena Community College in July.", "michael plans to visit Helena community college in July.", "Michael plans to visit Helena community College in july."], "Michael plans to visit Helena Community College in July.", "Proper names such as Helena Community College and July should be capitalized."],
    ...
    ["Which sentence keeps the modifier clear?", ["After studying for two hours, Michael felt more confident about algebra.", "After studying for two hours, algebra felt more confident to Michael.", "After Michael studied algebra for two hours, confidence increased it.", "After studying for two hours, the algebra workbook made Michael confident."], "After studying for two hours, Michael felt more confident about algebra.", "The correct sentence clearly shows that Michael did the studying."],
    ...
    ["Choose the best sentence.", ["The coach's feedback was direct, but it helped Michael improve quickly.", "The coach's feedback was direct but it helped Michael improve quickly.", "The coachs feedback was direct, but it helped Michael improve quickly.", "The coach's feedback direct, but it helped Michael improve quickly."], "The coach's feedback was direct, but it helped Michael improve quickly.", "The best version uses the apostrophe correctly and punctuates the compound sentence."],
    ["Which sentence uses tense consistently?", ["Michael reviewed notes, completed the quiz, and then checked his answers.", "Michael reviews notes, completed the quiz, and then checks his answers.", "Michael reviewed notes, completes the quiz, and then checked his answers.", "Michael reviewing notes, completed the quiz, and then checked his answers."], "Michael reviewed notes, completed the quiz, and then checked his answers.", "The sequence stays in the past tense from start to finish."],
  ...
  var revisionSpecs = [
    ...
    ["Which transition best connects these ideas? \"Michael improved his attendance. ___ his practice scores rose steadily.\"", ["As a result,", "For example,", "On the other hand,", "At first,"], "As a result,", "The second sentence shows an outcome of the first, so a cause-and-effect transition fits best."],
    ...
    ["Which revision removes redundancy?", ["Michael planned carefully before the exam.", "Michael planned carefully in advance before the exam.", "Michael planned carefully ahead before the exam.", "Michael planned very carefully and carefully before the exam."], "Michael planned carefully before the exam.", "Before already includes the idea of in advance, so the shorter version is stronger."],
